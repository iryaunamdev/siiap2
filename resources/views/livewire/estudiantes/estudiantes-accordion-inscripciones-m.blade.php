@if (isset($estudiante->inscripciones_m))
    @foreach ($estudiante->inscripciones_m->sortByDesc('semestre.nombre') as $inscripcion)
        <div id="accordion-flush-insc-m-{{ $inscripcion->id }}" data-accordion="collapse"
            data-active-classes="bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
            data-inactive-classes="text-gray-500 dark:text-gray-400">

            <h3 id="accordion-flush-heading-insc-m-{{ $inscripcion->id }}">
                <div
                    ...
                    <div>
                        ...
                        <button type="button"
                            data-accordion-target="#accordion-flush-body-insc-m-{{ $inscripcion->id }}"
                            aria-expanded="false"
            ...
            <div id="accordion-flush-body-insc-m-{{ $inscripcion->id }}" class="hidden"
                aria-labelledby="accordion-flush-heading-insc-m-{{ $inscripcion->id }}">
    ...
    @endforeach
@else
<span class="italic text-sm text-gray-400">No hay registros de inscripción en maestría.</span>
@endif
